package namtran.mygift.library;
...
import namtran.mygift.library.Animations.BaseAnimationInterface;
import namtran.mygift.library.Animations.DescriptionAnimation;
import namtran.mygift.library.Indicators.PagerIndicator;
import namtran.mygift.library.SliderTypes.BaseSliderView;
import namtran.mygift.library.Transformers.AccordionTransformer;
import namtran.mygift.library.Transformers.BackgroundToForegroundTransformer;
import namtran.mygift.library.Transformers.BaseTransformer;
import namtran.mygift.library.Transformers.CubeInTransformer;
import namtran.mygift.library.Transformers.DefaultTransformer;
import namtran.mygift.library.Transformers.DepthPageTransformer;
import namtran.mygift.library.Transformers.FadeTransformer;
import namtran.mygift.library.Transformers.FlipHorizontalTransformer;
import namtran.mygift.library.Transformers.FlipPageViewTransformer;
import namtran.mygift.library.Transformers.ForegroundToBackgroundTransformer;
import namtran.mygift.library.Transformers.RotateDownTransformer;
import namtran.mygift.library.Transformers.RotateUpTransformer;
import namtran.mygift.library.Transformers.StackTransformer;
import namtran.mygift.library.Transformers.TabletTransformer;
import namtran.mygift.library.Transformers.ZoomInTransformer;
import namtran.mygift.library.Transformers.ZoomOutSlideTransformer;
import namtran.mygift.library.Transformers.ZoomOutTransformer;
import namtran.mygift.library.Tricks.FixedSpeedScroller;
import namtran.mygift.library.Tricks.InfinitePagerAdapter;
import namtran.mygift.library.Tricks.InfiniteViewPager;
 ...
 *
 */
public class SliderLayout extends RelativeLayout implements View.OnTouchListener {
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        attributes.recycle();
        if (mIndicatorVisibility == PagerIndicator.IndicatorVisibility.Visible)
